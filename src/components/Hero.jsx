        ...
        <div className="hero-left-section">
          ...
          <div className="social-box">
            <div className="social-icons">
              ...
              <a href="mailto:hello@thethreebuttons.co.uk" className="social-icon" aria-label="Email">
                <svg viewBox="0 0 24 24" fill="currentColor">
                  <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>
                </svg>
              </a>
              <a href="https://www.google.com/maps/place/128+City+Road,+London,+United+Kingdom,+EC1V+2NX" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="Location">
                <svg viewBox="0 0 24 24" fill="currentColor">
