          ...
          <div className="social-box">
            <div className="social-icons">
              ...
              {data.contactInfo?.email && (
                <a href={`mailto:${data.contactInfo.email}`} className="social-icon" aria-label="Email">
                  <svg viewBox="0 0 24 24" fill="currentColor">
                    <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>
                  </svg>
                </a>
              )}
              {(data.contactInfo?.addressLine1 || data.contactInfo?.postalCode) && (
                <a
                  href={`https://www.google.com/maps/place/${encodeURIComponent(`${data.contactInfo.addressLine1}, ${data.contactInfo.addressLine2}, ${data.contactInfo.postalCode}`)}`}
                  target="_blank"
