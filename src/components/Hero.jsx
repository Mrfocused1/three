      ...
      <div className="hero-content">
        <div className="hero-left-section">
          <div className="logo-box">
            <div className="logo">
              <img src="https://github.com/Mrfocused1/trimline-barbershop/blob/main/hero%20image.jpg?raw=true" alt="The Three Buttons" />
            </div>
          </div>
          <div className="hero-middle">
            <p className="tagline">
              A group of friends with a few videos online, over <strong>100 million</strong> fans and billions of views
            </p>
          </div>
